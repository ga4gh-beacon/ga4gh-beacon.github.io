...
<table>
  <tr>
    <td align="center" width="50%">
      <h3>Adaptable Framework</h3><img src="https://github.com/AnaT-DCO/dev-beacon-web-ana.github.io/blob/main/docs/img/Adaptable.svg?raw=true" alt="Adaptable Framework icon" width="250"><br>
...
<table>
  ...
  Beacon provides an extensive set of standardized terms, supporting data annotation for diverse use cases.<br>
    ...
    <td align="center" width="50%">
       <h3>Standardized Data Schema</h3><img src="https://github.com/AnaT-DCO/dev-beacon-web-ana.github.io/blob/main/docs/img/Standardized.svg?raw=true" alt="Standardized Dara Schema icon" width="250"><br>
...
<table>
  ...
  Beacon enables a wide range of genomic queries, from simple to advanced searches, supporting diverse research needs.<br>
    ...
    <td align="center" width="50%">
       <h3>Powerful Query Filters</h3><img src="https://github.com/AnaT-DCO/dev-beacon-web-ana.github.io/blob/main/docs/img/Standardized.svg?raw=true" alt="Standardized Data Schema icon" width="250"><br>
      Built upon existing global standards (e.g. GA4GH Phenopackets and VRS), Beacon ensures seamless data integration and exchange between different research infrastructures.<br>
    <a href="https://docs.genomebeacons.org/formats-standards/">Beacon Formats, Standards and Integrations</a>
    </td>
  </tr>
...
<table>
  <tr>
    <td align="center" width="50%">
       <h3>Multiple Query Methods (POST vs. GET)</h3><img src="https://github.com/AnaT-DCO/dev-beacon-web-ana.github.io/blob/main/docs/img/Multi-query.svg?raw=true" alt="Multiple Query Methods icon" width="250"><br>
...
<table>
  <tr>
    <td align="center" width="50%">
       <h3>Configurable Response Granularity</h3><img src="https://github.com/AnaT-DCO/dev-beacon-web-ana.github.io/blob/main/docs/img/Granularity.svg?raw=true" alt="Configurable Response Granularity icon" width="250"><br>
    ...
    <td align="center" width="50%">
      <h3>Handover Options</h3><img src="https://github.com/AnaT-DCO/dev-beacon-web-ana.github.io/blob/main/docs/img/Handover.svg?raw=true" alt="Handover Options icon" width="250"><br>
