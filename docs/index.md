...
![Beacon general figure](./img/Beacon-graphics-v2-network-960x540.png)
...
![Beacon video thumbnail](./img/Beacon-video.png)
...
![Beacon in numbers](./img/Beacon-in-numbers.svg)
